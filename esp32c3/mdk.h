...
#define DMA_IN_LINK_CH0_REG (C3_GDMA + 0x080)
#define DMA_OUT_LINK_CH0_REG (C3_GDMA + 0x0E0)
...
#define DMA_IN_PERI_SEL_CH0_REG (C3_GDMA + 0x0A0)
#define DMA_OUT_PERI_SEL_CH0_REG (C3_GDMA + 0x100)
