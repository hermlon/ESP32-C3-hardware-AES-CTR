...
/* GDMA */
#define DMA_IN_CONF0_CHn_REG(n) (C3_GDMA + 0x070 + (192*n))
#define DMA_OUT_CONF0_CHn_REG(n) (C3_GDMA + 0x0D0 + (192*n))
#define GDMA_IN_RST_CHn (BIT(0))
#define GDMA_OUT_RST_CHn (BIT(0))

#define DMA_IN_LINK_CHn_REG(n) (C3_GDMA + 0x080 + (192*n))
#define DMA_OUT_LINK_CHn_REG(n) (C3_GDMA + 0x0E0 + (192*n))
#define DMA_INLINK_ADDR_CHn 0x000FFFFF
#define DMA_OUTLINK_ADDR_CHn 0x000FFFFF
#define DMA_INLINK_START_CHn BIT(22)
#define DMA_OUTLINK_START_CHn BIT(21)

#define DMA_IN_PERI_SEL_CHn_REG(n) (C3_GDMA + 0x0A0 + (192*n))
#define DMA_OUT_PERI_SEL_CHn_REG(n) (C3_GDMA + 0x100 + (192*n))
#define PERI_SEL_AES 6

#define GDMA_MISC_CONF_REG 0x044
